...
fn execute_ytdlp(args: &[String], use_python: bool) -> Result<std::process::Output, std::io::Error> {
...
async fn download_video(
    ...
    if config.extract_audio {
        ...
        // Mantener video original si falla la conversión
    ...
    match output {
        ...
        Ok(out) => {
            ...
            if error_msg.contains("Postprocessing") && error_msg.contains("ffprobe") && stdout_msg.contains("100%") {
